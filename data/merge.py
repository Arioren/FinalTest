...
data1 = pd.read_csv(r'C:\Users\ARI\PycharmProjects\FinalTest\data\globalterrorismdb_0718dist.csv', encoding='iso-8859-1')
data2 = pd.read_csv(r'C:\Users\ARI\PycharmProjects\FinalTest\data\RAND_Database_of_Worldwide_Terrorism_Incidents.csv', encoding='iso-8859-1')
...
merged_data.to_csv(r'C:\Users\ARI\PycharmProjects\FinalTest\data\merge.csv', index=False)
